...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
			...
			Cliente cli1 = new Cliente(null, "Maria Silva", "estudo076@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("1234"));
			cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

			Cliente cli2 = new Cliente(null, "Ana Paula", "123456789123@hotmail.com", "47375597847", TipoCliente.PESSOAFISICA, pe.encode("1234"));
			cli2.addPerfil(Perfil.ADMIN);
			cli2.getTelefones().addAll(Arrays.asList("1132323131", "11954546464"));
			
			Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
			Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
			Endereco e3 = new Endereco(null, "Rua Son Goku", "04", "Casa1", "Centro", "78782880", cli2, c2);
